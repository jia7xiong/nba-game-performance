...
const getText = (localKey) => {
    switch(localKey) {
        ...
        case 'bar':
            return "The height of each bar represents the NBA players’ average performance. Different aspects can be selected through the dropdown menu.";
        case 'choropleth':
        ...
        default:
            return "The charts use data contains NBA season 2018-2019."
    }
}
